...
class MyContext:
    ...
    def __exit__(self, exc_type, exc, tb):
        ...
        注意：
            ...
            2. 函数返回 boolean 值，若忘记返回，即返回 None，相当于是返回了 False
        """
        print("exit")
...
if __name__ == "__main__":
    ...
    #   4. 用户代码块会不会抛出异常，都不影响 __exit__ 方法的执行。若用户代码有异常产生，异常信息会传递到 __exit__ 方法中，context manager 可以选择是否向外传递（即传递到 with 外层）；
